...
// import necessary classes for input handling and regex pattern matching
...
public class PROG56121PART1 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            status = PROG56121PART1.loginUser(loginUsername, loginPassword, storedUsername, storedPassword);
